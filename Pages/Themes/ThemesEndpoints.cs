...
namespace RosieTaylorBranding.Pages.Themes;

public static class ThemesEndpoints
{
    public static WebApplication MapThemesEndpoints(this WebApplication app)
    {
        app.MapGet(
                "/api/themes",
                (HttpContext context) =>
                {
                    const string currentVersion = "\"theme-v1.0\"";
                    ...
                    return new RazorComponentResult<ThemesPage>();
                }
            )
            .WithName("Theme");
